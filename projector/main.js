...
class TraxeProjector {
    constructor() {
        ...
        this.backgroundStyle = 'A'; // 'A' = image background, 'B' = gradient background
    ...
    drawTarget() {
        ...
        // Create exactly 5 rings alternating purple and orange
        // Ring 1 (center/bullseye): purple
        bullseyeGradient.addColorStop(0, 'rgba(124, 58, 237, 0.9)');      // Center - purple (#7C3AED)
        bullseyeGradient.addColorStop(0.19, 'rgba(124, 58, 237, 0.9)');   // End of ring 1
        
        // Ring 2: orange
        bullseyeGradient.addColorStop(0.2, 'rgba(255, 140, 66, 0.8)');     // Start of ring 2 - orange (#FF8C42)
        bullseyeGradient.addColorStop(0.39, 'rgba(255, 140, 66, 0.8)');    // End of ring 2
        
        // Ring 3: purple
        bullseyeGradient.addColorStop(0.4, 'rgba(124, 58, 237, 0.8)');  // Start of ring 3 - purple (#7C3AED)
        bullseyeGradient.addColorStop(0.59, 'rgba(124, 58, 237, 0.8)'); // End of ring 3
        
        // Ring 4: orange
        bullseyeGradient.addColorStop(0.6, 'rgba(255, 140, 66, 0.7)');      // Start of ring 4 - orange (#FF8C42)
        bullseyeGradient.addColorStop(0.79, 'rgba(255, 140, 66, 0.7)');     // End of ring 4
    ...
    drawBullseyeText(now) {
        ...
        // Flash between palette colors - instant color changes
        ...
        const colors = [
            ...
            this.accentVioletGlow,  // #A78BFA - Light violet
            '#FFFFFF'               // White (text0 from palette)
        ];
