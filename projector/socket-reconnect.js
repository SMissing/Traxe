...
(function() {
    ...
    function getDeviceId() {
        if (!deviceId) {
            deviceId = localStorage.getItem('traxe_projector_device_id');
        }
        return deviceId;
    }
    ...
    // Get lock-in info
    function getLockIn() {
        const saved = localStorage.getItem('traxe_projector_lock_in');
    ...
    function connectSocket() {
        ...
        socket.on('connect', () => {
            console.log('Socket.IO reconnected on projector game mode page');
        ...
        socket.on('disconnect', () => {
            console.log('Socket.IO disconnected on projector game mode page');
        });
